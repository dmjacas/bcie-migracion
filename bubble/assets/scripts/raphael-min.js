...
!function (a) {
    ...
    var za = b.pathBBox = function (a) {
        ...
        c = H(c).replace(/\.{3}|\u2026/g, a), a = b.parseTransformString(a) || [],
    ...
    "function" == typeof define && define.amd ? define("raphael.vml", ["raphael.core"], function (a) {
        return b(a)
    }) : b("object" == typeof exports ? require("raphael") : a.Raphael)
}(this, function (a) {
    if (!a || a.vml) {
    ...
    if ("function" == typeof define && define.amd)define("raphael", ["raphael.core", "raphael.svg", "raphael.vml"], function (a) {
        return b(a)
